function shoppingCart() {
    ...
    function addProduct(event) {
        ...
        let productName = currentProduct.getElementsByClassName("product-title")[0].innerHTML;
        let productPrice = Number(currentProduct.getElementsByClassName("product-line-price")[0].innerHTML);
